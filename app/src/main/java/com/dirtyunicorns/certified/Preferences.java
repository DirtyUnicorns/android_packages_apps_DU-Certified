...
public class Preferences {
    ...
    public static void ThemeToolbarNavBar(Activity activity, Toolbar toolbar) {
    ...
    public static void themePager(Activity activity, SlidingTabLayout sliding_tabs) {

        Preferences preferences = new Preferences(activity);

        sliding_tabs.setBackgroundColor(preferences.Theme());
    }
