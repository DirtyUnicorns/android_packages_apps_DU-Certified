    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetDataButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                com.dirtyunicorns.certified.Preferences.resetPrefs(SettingsActivity.this);
                recreate();
            }
        });
        ...
        listener = new SharedPreferences.OnSharedPreferenceChangeListener() {
            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String id) {
                com.dirtyunicorns.certified.Preferences.ThemeToolbarNavBar(SettingsActivity.this, toolbar);
            }
        };
